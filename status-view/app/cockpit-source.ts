...
export const cockpitSnapshot: CockpitSnapshot = {
  ...
  components: [
    ...
    },
    {
      ...
      role: "Slack Capture Adapter",
      state: "ready",
      reading: "IMPLEMENTED / LOCAL_ONLY",
      observedOn: "12 Aug 2026 19:04 IST",
      freshness: "Local 11 unit tests passed",
      sourceIds: ["slack-adapter"],
      detail: "Adapter workflow & package prepared locally. Ready for autonomous deployment.",
    },
    {
      id: "status-bridge",
  ...
  workstreams: [
    ...
    },
    {
      ...
      name: "Slack Resource Inbox",
      state: "ready",
      label: "IMPLEMENTED / LOCAL_ONLY",
      lastUpdate: "12 Aug 2026",
      nextStep: "Complete end-to-end local testing & credentials check.",
      sourceId: "slack-adapter",
    },
    {
      id: "cockpit-work",
