...
return [{
  json: {
    ...
    message: 'Captured to Life OS: ' + dossierPath,
    summary: storyText,
    trust_score: 90
  }
}];"""
...
nodes = [webhook_node, code_node, respond_node]
connections = {
  "Watch Private Resource Inbox Webhook": { "main": [[{ "node": "Unified Slack Inbox Engine", "type": "main", "index": 0 }]] },
  "Unified Slack Inbox Engine": { "main": [[{ "node": "Respond to Webhook", "type": "main", "index": 0 }]] }
}
...
nodes_capture = [webhook_node_capture, code_node, respond_node]
connections_capture = {
  "Webhook": { "main": [[{ "node": "Unified Slack Inbox Engine", "type": "main", "index": 0 }]] },
  "Unified Slack Inbox Engine": { "main": [[{ "node": "Respond to Webhook", "type": "main", "index": 0 }]] }
}
...
db.commit()
print("✅ Deployed respondWith: 'firstIncomingItem' returning TOP-LEVEL OBJECT!")
